...
if pwd.split('/')[-1]== 'coyote_lake_field_data':
    ...
    if keep_going == 'y':
        ...
        if add_new_folder == 'y':
            ...
            #call(['mkdir', path_to_external_drive+new_folder_name]) # <-------- IF THIS OVERWRITES A PREEXISTING FOLDER THAT WOULD BE HORRIBLE.
        ...
        #call(['ln', '-s', external_drive_trapcam_timelapse_path, pwd+'/'+new_folder_name+'/'+'/trapcam_timelapse']) # <----- IF THIS OVERWRITES A PREEXISTING DIRECTORY THAT WOULD BE HORRIBLE
